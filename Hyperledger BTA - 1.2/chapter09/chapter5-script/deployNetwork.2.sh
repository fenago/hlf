...
echo -e "${RED} Before Installing Network here, please Install Network on HOST#1 ${RESET}" | indent
...
echo -e "${RED} Starting Network on HOST#1, will also start network here ${RESET}" | indent
read -p "Press any key to continue... " -n1 -s
